...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('menu-list', '<ol class="menu-list"> <li each="{item in menu}" class="menu-item {date.isToday(item.date) ? \'today\' : \'open-popup\', date.week(item.date)}"> <div class="date">{date.date(item.date)}<span class="week">{date.week(item.date)}</span></div> <ol if="{!date.isToday(item.date)}" class="item-list"> <li class="list-item"> <div class="label">朝</div> <div onload="{m_main = item.m_main.split(\',\')}" class="menu"><span>{m_main[0]}</span><span if="{m_main[1]}"> / {m_main[1]}</span></div> </li> <li class="list-item"> <div class="label">昼</div> <div class="menu"><span>{item.l_main}</span></div> </li> <li class="list-item"> <div class="label">夜</div> <div onload="{d_main = item.d_main.split(\',\')}" class="menu"> <div if="{d_main[1]}"><span>{d_main[0]}</span><span>{d_main[1]}</span></div> <div if="{!d_main[1]}"></div> </div> </li> </ol> <ol if="{date.isToday(item.date)}" class="item-list"> <li class="list-item"> <div class="label">朝</div> <div onload="{m_main = item.m_main.split(\',\')}" class="menu"><span class="main">{m_main[0]}</span><span if="{m_main[1]}" class="main">{m_main[1]}</span> <hr class="partition"><span each="{m_side in item.m_side.split(\',\')}" class="side">{m_side}</span> </div> </li> <li class="list-item"> <div class="label">昼</div> <div class="menu"><span class="main">{item.l_main}</span> <hr class="partition"><span each="{l_side in item.l_side.split(\',\')}" class="side">{l_side}</span> </div> </li> <li class="list-item"> <div class="label">夜</div> <div onload="{d_main = item.d_main.split(\',\')}" class="menu"> <div if="{d_main[1]}"><span class="main">{d_main[0]}</span><span class="main">{d_main[1]}</span> <hr class="partition"><span each="{d_side in item.d_side.split(\',\')}" class="side">{d_side}</span> </div> <div if="{!d_main[1]}"><span class="event">{d_main[0]}</span></div> </div> </li> </ol> </li> </ol>', '', '', function (opts) {
